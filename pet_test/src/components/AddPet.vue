<template>
    <div class="card">
      ...
      <div class="photo-input">
        ...
        <div id="imageList">
            <img v-for="(image, index) in uploadedImages" :key="index" :src="image" alt="Preview Image" class="preview-image">
        </div>
      </div>
    ...
    methods: {
      ...
      for (let i = 0; i < fileList.length; i++) {
        ...
        if (file.type.startsWith('image/')) {
          ...
          reader.onload = (e) => {
            this.uploadedImages.push(e.target.result); // Push the URL to the uploadedImages array
          };
