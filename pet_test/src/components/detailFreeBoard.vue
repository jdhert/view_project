              ...
              <div class="comments" v-for="comment in comments" :key="comment.id">
                <div class="comment">
                  ...
                  <div class="comment-content">
                    ...
                    <div class="like-commented" @submit.prevent="handle">
                      <div class="user-comment" v-if="!updateButton">{{ comment.content }}</div>
                      <div class="user-comment" v-if="updateButton"><input :value="comment.content"></div>
                      <input type="submit" v-if="updateButton">                      
